#!/usr/bin/env python3
"""
group-meeting - LaTeX Formula Renderer

Vendored from ppt-master `skills/ppt-master/scripts/latex_render.py`.
Render manifest-declared LaTeX formulas to transparent PNG assets for
OfficeCLI picture insertion into the DUT group-meeting template.

Usage:
    /Users/wjb/miniconda3/envs/ppt-master/bin/python3 \
      ~/.claude/skills/group-meeting/scripts/latex_render.py <project_path>
    ... --manifest images/formula_manifest.json
    ... --dry-run

Dependencies:
    Pillow (transparent PNG post-process + dimensions)
    Network access to codecogs / quicklatex / mathpad / wikimedia
"""
